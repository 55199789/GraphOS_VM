...
public:
    AVLTree(long long maxSize, Bid& rootKey, unsigned long long& rootPos, map<Bid, string>* pairs, map<unsigned long long, unsigned long long>* permutation);
    AVLTree(long long maxSize, bool isEmptyMap);
    AVLTree(long long maxSize, long long initialSize, Bid& rootKey, unsigned long long& rootPos);
    virtual ~AVLTree();
    int totheight = 0;
